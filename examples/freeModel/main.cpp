...
/**
 * @brief Main function for the free model example.
 *
 * This example demonstrates the use of the NRG framework to solve a free model
 * problem. It initializes a spin-half impurity and a bath, then iteratively
 * adds bath sites and diagonalizes the Hamiltonian. Finally, it performs a
 * backward iteration to calculate thermodynamic properties.
 *
 * @return 0 on success.
 */
int main() {
